...
/* Smarty version 4.3.1, created on 2025-10-22 21:43:34
  from '/config/www/plugins/AdminTools/template/public_controller.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_68f933e69ab131_66829910',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5f0bc96d919a173d307756a409c4f07d6492d9d4' => 
    array (
      0 => '/config/www/plugins/AdminTools/template/public_controller.tpl',
      1 => 1760982612,
      2 => 'file',
    ),
  ),
...
function content_68f933e69ab131_66829910 (Smarty_Internal_Template $_smarty_tpl) {
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/public_style.css')),$_smarty_tpl ) );
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>'admin/themes/default/fontello/css/fontello.css'),$_smarty_tpl ) );
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0], array( array('id'=>'mousetrap','load'=>'footer','path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/mousetrap.min.js')),$_smarty_tpl ) );
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('id'=>'colorbox','path'=>'themes/default/js/plugins/colorbox/style2/colorbox.css'),$_smarty_tpl ) );
if ((isset($_smarty_tpl->tpl_vars['ato']->value['IS_PICTURE']))) {
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0], array( array('id'=>'jquery.tokeninput','load'=>'footer','require'=>'jquery','path'=>'themes/default/js/plugins/jquery.tokeninput.js'),$_smarty_tpl ) );
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>'themes/default/js/plugins/jquery.tokeninput.css'),$_smarty_tpl ) );
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0], array( array('id'=>'jquery.ui.datepicker','load'=>'footer','path'=>'themes/default/js/ui/jquery.ui.datepicker.js'),$_smarty_tpl ) );
$_smarty_tpl->_assignInScope('datepicker_language', (('themes/default/js/ui/i18n/jquery.ui.datepicker-').($_smarty_tpl->tpl_vars['lang_info']->value['code'])).('.js'));
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0], array( array('id'=>('jquery.ui.datepicker-').($_smarty_tpl->tpl_vars['lang_info']->value['code']),'load'=>'footer','path'=>$_smarty_tpl->tpl_vars['datepicker_language']->value),$_smarty_tpl ) );
}
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>'themes/default/js/ui/theme/jquery.ui.core.css'),$_smarty_tpl ) );
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>'themes/default/js/ui/theme/jquery.ui.theme.css'),$_smarty_tpl ) );
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0], array( array('path'=>'themes/default/js/ui/theme/jquery.ui.datepicker.css'),$_smarty_tpl ) );
}
}
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0], array( array('id'=>'admintools.controller','load'=>'footer','require'=>'jquery','path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/public_controller.js')),$_smarty_tpl ) );?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['ato']->value['DELETE_CACHE'])) && $_smarty_tpl->tpl_vars['ato']->value['DELETE_CACHE']) {?>
...
, {
    hintText: '<?php echo strtr((string)l10n('Type in a search term'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
',
    noResultsText: '<?php echo strtr((string)l10n('No results'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
',
    searchingText: '<?php echo strtr((string)l10n('Searching...'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
',
    newText: ' (<?php echo strtr((string)l10n('new'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
)'
  });
...
" onclick="return confirm('<?php echo strtr((string)l10n('Are you sure?'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
')"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'ucfirst' ][ 0 ], array( l10n('delete photo') ));?>
</a></li>
<?php }?>
      </ul>
    </li>
...
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'ucfirst' ][ 0 ], array( l10n('representative') ));?>
</a></li>
<?php }
if ((isset($_smarty_tpl->tpl_vars['ato']->value['U_CADDIE']))) {?>
    <li <?php if ((isset($_smarty_tpl->tpl_vars['ato']->value['IS_IN_CADDIE'])) && $_smarty_tpl->tpl_vars['ato']->value['IS_IN_CADDIE']) {?>class="disabled"<?php }?>><a class="icon-flag add-caddie ato-min-2" href="<?php echo $_smarty_tpl->tpl_vars['ato']->value['U_CADDIE'];?>
...
">
      ...
      <fieldset class="main">
        ...
        <input type="text" name="name" id="quick_edit_name" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT']['name'], ENT_QUOTES, 'UTF-8', true);?>
">

<?php if ((isset($_smarty_tpl->tpl_vars['ato']->value['IS_PICTURE']))) {?>
        <label for="quick_edit_author"><?php echo l10n('Author');?>
</label>
        <input type="text" name="author" id="quick_edit_author" <?php if ((isset($_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT']['author']))) {?> value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT']['author'], ENT_QUOTES, 'UTF-8', true);?>
" <?php }?>>
...
<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT']['tag_selection'], 'tag');
